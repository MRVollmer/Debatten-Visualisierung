...
Die wichtigste Designentscheidung und damit Grundidee des Layouts ist es, jede Gruppe in einer Kugel zu kapseln. Sie wird also innerhalb eines Kreises dargestellt und Kanten über Gruppengrenzen werden nur über feste Ports zugeführt.
...
\todo[inline]{Kugel -> Kreis}
\todo[inline]{Port Definition}
\begin{figure}[h!]
\begin{center} 
...
\todo[inline]{Vorrausblick rest des Kapitels}
...
Mit diesem Problem hat sich zum Beispiel bereits \todo[inline]{Name?} \cite{Harel:2002:DGN:1556262.1556288} beschäftigt.
...
Wie die Größe einer geöffneten Gruppe berechnet werden kann ist in \todo[inline]{Referenz Fallsch} \autoref{Radius} genauer beschrieben. 
...
relativ großen Gruppen, schlagen wir eine logoarithmische Abbildung wie in \autoref{f:Radius} vor.
\begin{figure}[h!]
\begin{center} 
...
\subsection*{Anker}
\todo[inline]{Abschnit später erst}
...
\end{algorithm}
\todo[inline]{Algo fixen}


\subsection{Bottom-up Anteil des Algorithmus}
\todo[inline]{3.1.1
Layout der Gruppen in Abhängigkeit von ports
3.1.2
Ports für Eltern finden

Bisheriges 3.1.1 und 3.1.2 verschmelzen}
...
% was betrachten?
In diesem Abschnitt betrachten wir Zeile 13 des \hyperref[Layoutalgorithmus]{Layoutalgorithmus~\ref*{Layoutalgorithmus}} genauer. 
% was ist ziel?
...
Der grobe Ablauf des Algorithmus ist in \autoref{Gruppenlayoutalgorithmus} beschrieben. 
...
Für die Wahl eines Anfangslayouts, Zeile 1 in \autoref{Gruppenlayoutalgorithmus}, schlagen wir folgenden Ansatz vor.
...
Dessen Idee ist es, für einen gegeben Radius ein Layout zu berechnen und dann zu testen, ob der Radius verkleinert werden kann. 
...
Als Anfangsradius kann der Radius $R'_H$ aus \autoref{Layoutalgorithmus} Zeile 5 mal einem Faktor $\beta$ verwendet werden.
\autoref{Kreisradiusalgorithmus} spezifiziert also Zeile 2 von \autoref{Gruppenlayoutalgorithmus} und setzt auch dessen Zeile 3 um.
