...
Dadurch werden die gruppeninternen Layouts von dem Rest des Layouts getrennt. Ist ein Layout einer übergeordneten Gruppe oder der obersten Stufe berechnet, 
...
Dieses soll, wie oben beschrieben, ein Layout innerhalb eines Kreises sein und Kanten, die die Gruppengrenze überschreitenden, zu den festgelegten Ports führen.
% was ist schwierig?
...
Des Weiteren haben wir bereits ein Layout $\mathcal{L_H}$ der Gruppe $H$ ohne Kanten, die die Gruppengrenze überschreitenden, in Zeile 4 des \hyperref[Layoutalgorithmus]{Layoutalgorithmus~\ref*{Layoutalgorithmus}}  berechnet. 
