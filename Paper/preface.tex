...
Allgemeine Layoutanforderungen sind solche, bei denen die Gruppierungen der Argumentkarte keine Rolle spielt.
...
\item {\normalfont \bfseries{Größenminimierung:}} \newline Bei gegebener Größe von Knoten und Kanten sollten die Knoten so angeordnet werden das die Gesamtgröße des Layouts minimiert wird.
\end{itemize}

\section{Gruppensensitive Layoutanforderungen}
\label{sec:groupreq}
Die gruppensensitive Layoutanforderungen sind solche, die direkt von der Gruppierung von Aussagen oder Argumenten abhängig.
