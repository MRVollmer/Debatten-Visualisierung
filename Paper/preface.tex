...
Beispielsweise steht die Größenminimierung der Zeichnung im Konflikt mit der Anforderung, das sich das Gesamtlayout viel wie nötig ändert, da größenminimale Layouts nach dem öffnen bzw. schließen einer Gruppe möglicherweise nur mit einer großen Veränderung des Layouts möglich sind.
...
Die genaue Betrachtung der Probleme und ihrer Lösung findet sich in ... %\autoref{...}
\todo[inline]{Problembetrachtung schreiben}
