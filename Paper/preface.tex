...
\todo[inline]{Bitte jemand kurz Querprüfen, ob die Clustering-Abgrenzung hier inhaltlich gut passt}
...
\todo[inline]{vorherigen beiden Sätze tauschen?}
\todo[inline]{Umgeschrieben - Meinungen?}
\todo[inline]{Beispielgraph/layout (vorziehen) und Baum und Schnitt hinzufügen? - ist das nicht erledigt?}
...
\begin{itemize}
\item Das Layout ändert sich nur so viel wie nötig sowohl im Hinblick auf das mikroskopische als auch das makroskopisch Layout
